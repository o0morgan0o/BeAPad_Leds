...
void setup() {
  ...
  // *************************************************************************
  // *************************************************************************
  // GONZY !!! C'est ICI QUE TU CHANGES LES COULEURS
  ...
  ledBoardsManager->setLightStrategyForChannel(2, LIGHT_STRATEGIES::STRATEGY_FADE_OUT, CRGB{60,87,13});
  ledBoardsManager->setLightStrategyForChannel(3, LIGHT_STRATEGIES::STRATEGY_SERPENTIN, CRGB{76,125,117});
  ledBoardsManager->setLightStrategyForChannel(4, LIGHT_STRATEGIES::STRATEGY_FLASH_TOWARDS_EXTERIOR, CRGB::BlueViolet);
  ledBoardsManager->setShiftColor(CRGB::White); // Shift Color
  // *************************************************************************
  // *************************************************************************
